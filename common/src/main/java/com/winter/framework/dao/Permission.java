...
public class Permission implements Serializable {
    ...
    public Permission(Integer permissionId, String name, String permissionValue) {
        this.permissionId = permissionId;
        this.name = name;
        this.permissionValue = permissionValue;
    }
    ...
    static {
        ...
        admin.add(permission2);

        List<Permission> user = new ArrayList<>();
        user.add(permission1);

        permissionMap.put("admin", admin);
        permissionMap.put("user1", user);
        permissionMap.put("user2", user);


    }
    public static List<Permission> getPermission(String username){
